As of January 2026, apps built and run inside Google AI Studio can still use generative tokens at no cost, including both code generation that creates the app, and text-to-image generation through the app you created.
